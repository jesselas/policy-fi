...
//   1. entries with an explicit `added` ISO date, newest first — the same
//      direction the /research "Recently Added" view uses, so a new entry
//      leads on both pages instead of leading on one and trailing on the other,
